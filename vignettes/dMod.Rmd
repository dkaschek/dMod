...
fitlist <- mstrust(obj + constr, center = myfit$argument, fits = 20, cores = 4, sd = 1, samplefun = "rnorm", fixed = fixed, conditions = "Epo")
...
myprofile <- profile(obj + constr, pars = myfit$argument, whichPar = "s_EpoR", fixed = fixed, cores = 1)
